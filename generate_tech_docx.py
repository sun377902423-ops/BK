#!/usr/bin/env python3
"""Convert 技术方案说明.md to a clean business-friendly Word document."""
...
MD_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "docs", "技术方案说明.md")
OUT_PATH = os.path.join(DESKTOP, "BKSYS-MED_技术方案说明.docx")
...
def main():
    ...
    subtitle = doc.add_paragraph('技术方案说明')
    ...
    hp.text = 'BKSYS-MED 远程医疗会诊系统 — 技术方案说明'
